const AddCoffee = () => {
  return (
    <div className="max-w-7xl mx-auto px-4">
      <h2 className="text-center my-8 font-bold text-xl">Add a coffeee</h2>
      <form className="w-[700px] mx-auto">
        ...
        <button
          type="submit"
          className="btn border-0 text-black bg-success hover:bg-success focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-success dark:hover:bg-success dark:focus:ring-success"
        >
          Submit
        </button>
      </form>
